 ...
 * Returns `null` when the entry has no plan-backed messaging state.
 */
 ...
 * Entries without a plan return an empty map and are ignored by callers because
 * they have no active channels.
 */
