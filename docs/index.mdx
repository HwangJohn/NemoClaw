...
Copy the starter prompt from the following button and paste it into your assistant that's running on your local machine with access to the terminal.
...
Load NemoClaw's user skills for your AI coding assistant before you install or operate a sandbox.
...
The NemoClaw documentation provides user guide variants for the agents it supports. Select the variant that matches your agent. You can also select the variant from the dropdown at the top of the left navigation pane.
